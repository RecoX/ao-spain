...
'    Call LogTarea("Sub DoLingotes")
    ...
    If RandomNumber(1, 9) < 10 Then
                UserList(UserIndex).Invent.Object(UserList(UserIndex).Flags.TargetObjInvSlot).Amount = UserList(UserIndex).Invent.Object(UserList(UserIndex).Flags.TargetObjInvSlot).Amount - 1
                If UserList(UserIndex).Invent.Object(UserList(UserIndex).Flags.TargetObjInvSlot).Amount < 1 Then
                ...
                End If
                Call SendData(ToIndex, UserIndex, 0, "||Has obtenido diez lingotes!!!" & FONTTYPE_INFO)
