...
'ListaClases(20) = "Wilord" 'Neptuno
ListaClases(21) = "Aldeano" 'Neptuno
'ListaClases(22) = "Sastre" 'Neptuno
'ListaClases(22) = "Cocinero" 'Neptuno
'ListaClases(22) = "Camarero" 'Neptuno



ReDim SkillsNames(1 To NUMSKILLS) As String

SkillsNames(1) = "Equitacion"
SkillsNames(2) = "Magia"
SkillsNames(3) = "Robar"
...
frmMain.CantUsuarios.Caption = "Users Online: " & NumUsers
...
Else
  Call SendData(ToIndex, UserIndex, 0, "||Ya eres visible." & FONTTYPE_INFO)
...
Else
  Call SendData(ToIndex, UserIndex, 0, "||Envenenado, Vas a moriras." & FONTTYPE_VENENO)
