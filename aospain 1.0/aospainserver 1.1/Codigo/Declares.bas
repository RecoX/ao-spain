...
Public Const NPCTYPE_GUARDIASMALVADOS = 8
...
Public Const NUMCLASES = 22 'Neptuno
...
Public Const Resistencia = 22 '[Efestos]
...
Public Const OBJTYPE_TELEPENT = 36
'[Efestos]
Public Const OBJTYPE_CABALLOS = 37
'[Efestos]
'[Neptuno]
Public Const OBJTYPE_BARCOSARMADA = 38
'[Neptuno]
'<------------------SUB-CATEGORIAS----------------->
...
Public PassCliente As String '[Efestos]

'*********************************************************

Public Arcadia As WorldPos
