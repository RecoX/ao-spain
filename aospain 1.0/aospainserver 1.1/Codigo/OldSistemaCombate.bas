...
Select Case UCase(Clase)
    ...
    Case "BARDO"
        ModicadorDañoClaseProyectiles = 0.6
    Case "DRUIDA"
        ModicadorDañoClaseProyectiles = 0.65
    Case "PESCADOR"
    ...
    Case "CARPINTERO"
        ModicadorDañoClaseProyectiles = 0.6
    Case Else
        ModicadorDañoClaseProyectiles = 0.4
End Select
End Function
...
Dim DañoArma As Long, DañoUsuario As Long, Arma As ObjData, ModifClase As Long
