...
Begin VB.Form frmCrearPersonaje 
   ...
   Begin VB.Image command1 
      ...
      Index           =   42
      Left            =   8400
      MouseIcon       =   "frmCrearPersonaje.frx":02D1
      MousePointer    =   99  'Custom
      Top             =   7800
      Width           =   135
   End
   ...
   Begin VB.Image command1 
      ...
      Index           =   3
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":0423
      MousePointer    =   99  'Custom
      Top             =   3465
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   5
      Left            =   7785
      MouseIcon       =   "frmCrearPersonaje.frx":0575
      MousePointer    =   99  'Custom
      Top             =   3675
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   7
      Left            =   7785
      MouseIcon       =   "frmCrearPersonaje.frx":06C7
      MousePointer    =   99  'Custom
      Top             =   3885
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   9
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":0819
      MousePointer    =   99  'Custom
      Top             =   4110
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   11
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":096B
      MousePointer    =   99  'Custom
      Top             =   4335
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   13
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":0ABD
      MousePointer    =   99  'Custom
      Top             =   4545
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   15
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":0C0F
      MousePointer    =   99  'Custom
      Top             =   4785
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   17
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":0D61
      MousePointer    =   99  'Custom
      Top             =   4965
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   19
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":0EB3
      MousePointer    =   99  'Custom
      Top             =   5175
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   21
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":1005
      MousePointer    =   99  'Custom
      Top             =   5385
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   23
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":1157
      MousePointer    =   99  'Custom
      Top             =   5610
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   25
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":12A9
      MousePointer    =   99  'Custom
      Top             =   5820
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   27
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":13FB
      MousePointer    =   99  'Custom
      Top             =   6015
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   1
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":154D
      MousePointer    =   99  'Custom
      Top             =   3240
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   0
      Left            =   8355
      MouseIcon       =   "frmCrearPersonaje.frx":169F
      MousePointer    =   99  'Custom
      Top             =   3270
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   2
      Left            =   8355
      MouseIcon       =   "frmCrearPersonaje.frx":17F1
      MousePointer    =   99  'Custom
      Top             =   3495
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   4
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":1943
      MousePointer    =   99  'Custom
      Top             =   3720
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   6
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":1A95
      MousePointer    =   99  'Custom
      Top             =   3945
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   8
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":1BE7
      MousePointer    =   99  'Custom
      Top             =   4155
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   10
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":1D39
      MousePointer    =   99  'Custom
      Top             =   4380
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   12
      Left            =   8355
      MouseIcon       =   "frmCrearPersonaje.frx":1E8B
      MousePointer    =   99  'Custom
      Top             =   4605
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   14
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":1FDD
      MousePointer    =   99  'Custom
      Top             =   4800
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   16
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":212F
      MousePointer    =   99  'Custom
      Top             =   4995
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   18
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":2281
      MousePointer    =   99  'Custom
      Top             =   5220
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   20
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":23D3
      MousePointer    =   99  'Custom
      Top             =   5400
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   22
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":2525
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   24
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":2677
      MousePointer    =   99  'Custom
      Top             =   5850
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   26
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":27C9
      MousePointer    =   99  'Custom
      Top             =   6075
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   28
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":291B
      MousePointer    =   99  'Custom
      Top             =   6285
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   29
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":2A6D
      MousePointer    =   99  'Custom
      Top             =   6270
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   30
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":2BBF
      MousePointer    =   99  'Custom
      Top             =   6495
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   31
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":2D11
      MousePointer    =   99  'Custom
      Top             =   6465
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   32
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":2E63
      MousePointer    =   99  'Custom
      Top             =   6720
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   33
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":2FB5
      MousePointer    =   99  'Custom
      Top             =   6690
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   34
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":3107
      MousePointer    =   99  'Custom
      Top             =   6945
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   35
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":3259
      MousePointer    =   99  'Custom
      Top             =   6915
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   36
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":33AB
      MousePointer    =   99  'Custom
      Top             =   7170
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   37
      Left            =   7755
      MouseIcon       =   "frmCrearPersonaje.frx":34FD
      MousePointer    =   99  'Custom
      Top             =   7125
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   38
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":364F
      MousePointer    =   99  'Custom
      Top             =   7395
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   39
      Left            =   7770
      MouseIcon       =   "frmCrearPersonaje.frx":37A1
      MousePointer    =   99  'Custom
      Top             =   7335
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   40
      Left            =   8370
      MouseIcon       =   "frmCrearPersonaje.frx":38F3
      MousePointer    =   99  'Custom
      Top             =   7590
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   41
      Left            =   7815
      MouseIcon       =   "frmCrearPersonaje.frx":3A45
      MousePointer    =   99  'Custom
      Top             =   7560
      Width           =   135
   End
   Begin VB.Image boton 
      ...
      Index           =   2
      Left            =   315
      MouseIcon       =   "frmCrearPersonaje.frx":3B97
      MousePointer    =   99  'Custom
      Top             =   3015
      Width           =   660
   End
   Begin VB.Image boton 
      ...
      Index           =   1
      Left            =   1905
      MouseIcon       =   "frmCrearPersonaje.frx":3CE9
      MousePointer    =   99  'Custom
      Top             =   8565
      Width           =   765
   End
   Begin VB.Image boton 
      ...
      Index           =   0
      Left            =   9075
      MouseIcon       =   "frmCrearPersonaje.frx":3E3B
      MousePointer    =   99  'Custom
      Top             =   8565
      Width           =   1200
   End
   ...
   Begin VB.Image imgHogar 
      Height          =   2850
      Left            =   8775
      Picture         =   "frmCrearPersonaje.frx":3F8D
      Top             =   3900
      Width           =   2985
   End
